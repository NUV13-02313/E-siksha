  ...
  return (
    ...
    <Navbar/>
        ...
        <main className="main-content">
          ...
          <section id="why" className="content-section" style={{display: 'none'}}>
          ...
          {/* Careers Section */}
          <section id="careers" className="content-section" style={{display: 'none'}}>
          ...
          <section id="impact" className="content-section" style={{display: 'none'}}>
          ...
          {/* Contact Section */}
          <section id="contact" className="content-section" style={{display: 'none'}}>
          ...
          {/* Future Section */}
          <section id="future" className="content-section" style={{display: 'none'}}>
...
// JavaScript function needs to be defined outside the component or moved to a useEffect
...
// Note: You should add this to a useEffect in the component or initialize it differently
// The original script tag content is converted to a function
